...
import './release.less';
import { Radio, message, Upload, Button } from 'antd';
                    ...
                    <div className="_1GvkV">
                        <div className="_375hn">
                            <div className="_3yPS5">
                                ...
                                <img class="_39crF" alt="布局" src="data:image/png;base64," />
                            </div>
                        </div>
                        <b className="_3wF8X">效果预览</b>
                        <span class="_3CP_r _3FnBB">仅供参考，具体效果会根据不同手机型号而变化</span>
                    </div>
                </div>
            </div>
        )
